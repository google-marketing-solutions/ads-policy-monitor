...
<walkthrough-metadata>
  <meta name="title" content="Deploying Ads Policy Monitor" />
  <meta name="description" content="A step by step guide on configuring cloud and deploying the dashboard." />
</walkthrough-metadata>

## Introduction

In this walkthrough, you'll generate OAuth credentials in preparation for the deployment of Ads Policy Monitor.
...
Use [this link](https://groups.google.com/g/ads-policy-monitor-template-readers) to access the group URL and click on "Join Group"
...
Congratulations. You've set up Ads Policy Monitor!
